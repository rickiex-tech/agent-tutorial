...
Define failure classification semantics for MCP tool invocations and establish retry strategy boundaries between business failures (which terminate) and system failures (which may retry).
