...
Define the customer service ticket creation composite tool as a reference implementation of a fixed-sequence business orchestration tool, demonstrating strong precondition validation, fail-fast semantics, and tool reuse patterns.
