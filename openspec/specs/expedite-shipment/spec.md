...
Define the shipment expedite composite tool as a reference implementation of a multi-step business orchestration tool with state precondition validation, demonstrating serial execution, fail-fast semantics, and business rule enforcement via status whitelist.
